...
<table width="100%" align="center" border="0" bordercolor="#FFFFFF">
	...
	<tr>
        ...
        <?php
			...
			if($res){
			?>
            	<div class="info">Data Kategori dengan ID <?=$id_kategori?> telah diupdate. </div>
            <?php
			}
			else {
			?>
            	<div class="error">Data Kategori dengan ID <?=$id_kategori?> gagal diupdate, dengan pesan kesalahan <b><?=mysql_error()?></b>.
                </div>
            <?php
			}
		?>
