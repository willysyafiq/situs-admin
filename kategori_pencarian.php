	...
	<tr>
		...
		<div align="center">
			...
			<select name="fieldcari">
				<option value="id_kategori" <?php if(isset($_POST['tblcari'])) if($_POST['fieldcari']=="id_kategori") echo "selected";?>>ID Kategori</option>
				<option value="nama" <?php if(isset($_POST['tblcari'])) if($_POST['fieldcari']=="nama") echo "selected";?>>Nama Kategori</option> 
			</select>
